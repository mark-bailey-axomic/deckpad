// deckpad-icons.jsx — Lucide-lineage glyph set (24×24, 2px stroke, round caps/joins).
// The OpenAsset sprite has no terminal/code/database/monitor/camera symbols, so per the
// design system's "fill gaps with Lucide" guidance these are drawn inline at matching weight.
// currentColor everywhere — set color on the wrapper.
...
const DECK_ICON_PATHS = {
  ...
  beaker: <><path d="M9 3h6" /><path d="M10 3v6.5L4.7 18a2 2 0 0 0 1.7 3h11.2a2 2 0 0 0 1.7-3L14 9.5V3" /><line x1="6.5" y1="14" x2="17.5" y2="14" /></>,
  refresh: <><polyline points="21 4 21 10 15 10" /><path d="M20.49 15a9 9 0 1 1-2.12-9.36L21 8" /></>,
  bolt: <><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" /></>,
  cloud: <><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z" /></>,
  music: <><path d="M9 18V5l12-2v13" /><circle cx="6" cy="18" r="3" /><circle cx="18" cy="16" r="3" /></>,
  // chrome / control glyphs
...
function DeckIcon({ name, size = 24, strokeWidth = 2, style, className }) {
...
window.DECK_ICON_NAMES = Object.keys(DECK_ICON_PATHS);
